...
import com.vti.ufinity.teaching.management.security.service.UserDetailsServiceImpl;
import com.vti.ufinity.teaching.management.security.utils.SecurityConstants;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain) throws IOException,
		...
		if (requestURI.contains(
			SecurityConstants.LOGIN_REQUEST_URI) || requestURI.contains(SecurityConstants.REGISTRATION_REQUEST_URI)) {
